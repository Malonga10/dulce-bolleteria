...
const products = [
  ...
  {id:'platano-nuez', name:'Panqué de Plátano con Nuez', cats:['clasicos'], desc:'Plátanos maduros, dulzor natural y textura suave y esponjosa.', price:290, img:'imgs/panque_platano_nuez.jpeg'},
  ...
  {id:'chocolate', name:'Panqué de Chocolate', cats:['clasicos'], desc:'Intensamente chocolatoso, suave y con una cobertura irresistible.', price:290, img:'imgs/panque_chocolate_normal.jpeg'},
  ...
  {id:'avena-manzana', name:'Panqué de Avena con Manzana', cats:['saludables'], desc:'Harina de avena, manzanas ralladas y dulzor natural.', price:320, img:'imgs/panque_manza_avena.jpeg'},
  ...
  {id:'queso-bola', name:'Panqué de Queso de Bola', cats:['premium'], desc:'Panqué suave y humedo elaborado con queso de bola y mantequilla azul, cubierto con cremoso betún.', price:360, img:'imgs/panque_quesobola.jpeg'},
...
async function payWithCard(){
  ...
  try {
    ...
    if (data.init_point) {
      ...
      alert('No se pudo iniciar el pago. Intenta de nuevo o usa WhatsApp.');
      mpBtn.disabled = false;
      mpBtn.textContent = 'Pagar con tarjeta';
    }
  } catch (err) {
    console.error(err);
    alert('Hubo un error al conectar con el pago. Intenta de nuevo.');
    mpBtn.disabled = false;
    mpBtn.textContent = 'Pagar con tarjeta';
  }
}